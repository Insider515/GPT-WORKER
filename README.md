...
| Команда | Опис |
|---|---|
|ʼʼʼnpm install pm2-gʼʼʼ|Встановлення PM2 глобально|
|ʼʼʼsudo pm2 startupʼʼʼ|Включити запуск при завантаженні системи|
|ʼʼʼpm2 start app.jsʼʼʼ|Запуск програми з ім'ям app (або скрипта)|
|ʼʼʼpm2 listʼʼʼ|Перегляд процесів та їх станів|
|ʼʼʼpm2 restart appʼʼʼ|Рестарт додатку з назвою app|
|ʼʼʼpm2 restartʼʼʼ|Рестарт всіх додатків |
|ʼʼʼpm2 stop appʼʼʼ|Зупинка програми з ім'ям app|
|ʼʼʼpm2 stopʼʼʼ|Зупинка всіх додатків|
|ʼʼʼpm2 delete allʼʼʼ|Видалити всі програми зі списку pm2|
|ʼʼʼpm2 delete appʼʼʼ|Видалити додаток з назвою app|
|ʼʼʼpm2 logʼʼʼ|Перегляд усіх процессів у режимі реального часу|
|ʼʼʼlog appʼʼʼ|Перегляд дфяльності програми app у режимі реального часу|
|ʼʼʼpm2 initʼʼʼ|Створення конфігурації|
|ʼʼʼpm2 saveʼʼʼ|Збереження поточного стану до конфігурації|
|ʼʼʼpm2 resurrectʼʼʼ|Запуск поточних програм з файлу конфігурації|
|ʼʼʼpm2 start app.js -i 2ʼʼʼ|Запуск двох откремих єкземплярів|
|ʼʼʼpm2 start ecosystem.config.jsʼʼʼ|Запуск конфігурації|
|ʼʼʼpm2 start ecosystem.config.js --only appʼʼʼ|Запуск програми з назвою app зі списку конфігураційного стану|
|ʼʼʼpm2 start index.js --max-memory-restart 150Mʼʼʼ|Обмежити використання оперативної пам'яті|
|ʼʼʼpm2 start app.js --watchʼʼʼ|Ввімкнення режиму автоматичного перезавантаження програми при зміні якогось файлу (режиму стеження за станом)|
|ʼʼʼpm2 stop app --watchʼʼʼ|Заміна режиму автоматичного перезавантаження програми при зміні якогось файлу (режиму стеження за станом)|
